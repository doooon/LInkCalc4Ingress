...
function initialize(lat, lng, range) {
  ...
  mapCurrentLocationButtonDiv.innerHTML = '';
	...
	document.getElementById('map-inputLocation-div').addEventListener("click", function(e){ if(e.id="map-inputLocation-div"){document.getElementById('map-inputLocation-div').style.display = "none"} }, false);
