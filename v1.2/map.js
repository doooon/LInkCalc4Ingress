...
function initialize(lat, lng, range) {
  ...
  mapCurrentLocationButtonDiv.innerHTML = '';
	...
	document.getElementById('map-inputLocation-div-inner').addEventListener("click", function(e){ document.getElementById('map-inputLocation-div').style.display = "block"; }, false);
}
